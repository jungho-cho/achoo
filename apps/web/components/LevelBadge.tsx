...
const CONFIG: Record<Level, { bg: string; text: string; dot: string }> = {
  low:        { bg: 'bg-green-50',  text: 'text-green-700',  dot: 'bg-green-500' },
  moderate:   { bg: 'bg-yellow-50', text: 'text-yellow-700', dot: 'bg-yellow-400' },
  ...
  bad:        { bg: 'bg-orange-50', text: 'text-orange-700', dot: 'bg-orange-500' },
  'very-bad': { bg: 'bg-red-50',    text: 'text-red-700',    dot: 'bg-red-500' },
};
