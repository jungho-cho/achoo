...
const CHROME: Record<ArticleLocale, InsightsChrome> = {
  ko: {
    ...
    hubEyebrow: "트렌드 에디션",
    hubTitle: "지금 읽어야 할 알레르기 인사이트 10",
    hubDescription:
      "기후, 꽃가루, 공기질, 실내 환경 변화까지 2026년 기준으로 바로 행동에 옮길 수 있는 주제만 추렸습니다.",
    updatedLabel: "업데이트",
  ...
  en: {
    ...
    hubTitle: "10 allergy briefings worth reading now",
    hubDescription:
      "These pieces focus on the pollen, air, and indoor-environment shifts that matter most right now and turn them into practical decisions.",
  ...
  de: {
    ...
    backToHubLabel: "Trend-Briefings",
    hubEyebrow: "Trend Edition",
    hubTitle: "10 Allergie-Briefings, die man jetzt lesen sollte",
    hubDescription:
      "Hier geht es um die Pollen-, Luft- und Innenraumtrends, die 2026 wirklich relevant sind, übersetzt in konkrete Alltagsentscheidungen.",
  ...
  fr: {
    ...
    hubTitle: "10 briefings allergie à lire maintenant",
    hubDescription:
      "Ces articles se concentrent sur les évolutions 2026 des pollens, de l’air et de l’environnement intérieur, puis les traduisent en décisions utiles.",
